    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-lg-4">
          ...
          <img src="/img/business-profile/application_form_3.svg" alt="">
        </div>
        <div class="col-12 col-lg-4 middle-images">
          <div class="row">
            <div class="col-auto col-lg-12">
              <img :src="`/img/business-profile/application_form_1_${colorMode}.svg`" alt="">
            </div>
            <div class="col-auto col-lg-12">
              <img :src="`/img/business-profile/application_form_2_${colorMode}.png`" alt="">
            </div>
          </div>
        </div>
        <div class="col-12 col-lg-4">
