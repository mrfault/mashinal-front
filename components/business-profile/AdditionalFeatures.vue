  ...
  <div class="business-profile__additional-features">
    ...
    <div class="row section">
      ...
      <div class="col-12 col-lg-6 content">
        ...
        <img src="/img/business-profile/additional_features_illustration_2.svg" alt="" class="illustration-2">
      </div>
    </div>
    <hr class="m-0"/>
    ...
    <div class="row section">
      ...
      <div class="col-12 col-lg-6 content">
        ...
        <img src="/img/business-profile/additional_features_illustration_4.svg" alt="" class="illustration-4 mb-4 mb-lg-0">
      </div>
    </div>
    <hr class="m-0"/>
    ...
    <div class="row section" v-if="profileType === 'parts'">
      <div class="col-12 col-lg-6">
        <img :src="`/img/business-profile/${profileType}_additional_features_6_${colorMode}.png`" alt="">
      </div>
      <div class="col-12 col-lg-6 content">
        ...
        <img src="/img/business-profile/additional_features_illustration_6.svg" alt="" class="illustration-6">
      </div>
    </div>
  </div>
</template>
