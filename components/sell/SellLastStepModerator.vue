...
import CarNumberRejectReason from "~/pages/moderator/photoReject/CarNumberRejectReason";
import VinRejectReason from "~/pages/moderator/photoReject/VinRejectReason";


export default {
   components: {
      VinRejectReason,
      CarNumberRejectReason,
      PhotoRejectReason,
      RejectReason,
   ...
   methods: {
      ...
      changeReason(rejectKey) {
         ...
         if (rejectKey == 'car_number') {
            this.carNumberModal.carNumberModalIsOpen=true
         }
         if (rejectKey == 'vin') {
