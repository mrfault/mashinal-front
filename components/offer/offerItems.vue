  ...
  <div>
    <div class="offer_items">
      <div class="offer_item" :class="selected_offer_item==index ? 'active' : null"
        ...
        <img :src="'https://mashin.al/storage/3069082/1.jpeg'" alt="">
        <div class="offer_item_detail">
          ...
          <span>
                          {{ offer_item.generations[0].end_year }}
                        </span>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="offerDetailContent">
        ...
        <div class="offerDetailItem">
          <p>Model </p>
          <span>
                  {{ offer_items[selected_offer_item].model }}
                </span>
        </div>
        ...
        <div class="offerDetailItem">
          <p>Nəsil </p>
          <div>
                  <span v-for=" (generation,index) in offer_items[selected_offer_item].generations">
                  {{ generation.name }}
        ...
        <div class="offerDetailItem">
          ...
          <p>Sürətlər qutusu </p>
          <div>
                <span v-for=" (gearbox,index) in offer_items[selected_offer_item].gear_boxes">
        ...
        <div class="offerDetailItem">
          <p>Yanacaq növü </p>
          <div>
                <span v-for=" (fuel_type,index) in offer_items[selected_offer_item].fuel_types">
        ...
        <div class="offerDetailItem">
          <p>Rəng </p>
          <div>
                <span v-for=" (color,index) in offer_items[selected_offer_item].colors">
