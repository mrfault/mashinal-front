  ...
  <div class="action-bar d-lg-none">
    <div class="container">
      <div class="d-flex align-items-center justify-content-between">
        <!-- <icon name="chevron-left" @click.native.stop="$router.back()" class="cursor-pointer" /> -->
        <inline-svg src="/new-icons/chevron-left.svg" :height="14"  @click.native.stop="$router.back()" class="cursor-pointer" />
