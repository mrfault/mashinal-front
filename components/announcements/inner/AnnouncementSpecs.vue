  ...
  computed: {
    ...
    announcementSpecs() {
      const specs = [
        ...
        { key: 'first_owner', value: (parseInt(this.announcement.owner_type || this.announcement.owners || this.announcement.owner)) ? this.$t('yes') : this.$t('no'), for: ['cars', 'commercial', 'moto'] },
