<template>
  <div class="color-options row">
    <div class="col-2 col-lg-auto mb-2 mb-lg-3 custom-tooltip" v-for="(color, index) in colors" :key="color.id">
    ...
    <div class="col-2 col-lg-auto mb-2 mb-lg-3 custom-tooltip" key="matt" v-if="!hideMatt">
