<template>
  <div class="vue_component__upload--image" v-bind:class="{ 'dragover': onDragover }">
    <div v-if="loading || imageIsUploading" class="vue_component__upload--image__overlay" />
    ...
    <div>
          ...
          <form v-bind:id="'upload_image_form--' + input_id" enctype="multipart/form-data">
            <div class="hologram cursor-pointer d-flex mt-0" @click="handleFormClick">
              <a v-for="i in sellImageCount"
                ...
                <div class="icon" style="height: 88px; width: 100%; display: flex; align-items: center; justify-content: center;"
                >
                  ...
                  <img v-else-if="isCommetcial" :src="'/images/sell/comm_'+i+'.png'" alt="" style="width: auto;height: auto;">
                </div>
            ...
            >
              ...
              <draggable
                 ...
                 :sort="true"
                 :style="loadCroppa ? 'margin-left: 0px;' : ''"
      ...
      <no-ssr>
        <LightBox
           ...
           :key="'LB'+lbIndex"
           :media="fancyBoxMedia"
           :showLightBox="active_box"
           :startAt="LighBoxStart"
           @onClosed="active_box = false"
