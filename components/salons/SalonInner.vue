<template>
    <div class="salon-inner">
        <div
            :class="
            ['profile-card salon-single-card overflow-hidden mt-0 mb-lg-3',
              salonSingle.description ? 'mb-n3' : 'mb-2'
            ]"
        >
            <div
                class="cover-with-avatar"
            >
                <img
                    class="cover-with-avatar__img"
...
<!--                </span>-->
            ...
            <div class="row align-items-lg-end profile_info">
                <div class="col-lg-12 mb-2 d-flex">
                    <div v-if="salonSingle.phones && salonSingle.phones.length"
                         class="profile_info-details border-padding-none mr-5">
