export default {
  ...
  "you_can_create_announcement_parts": "Siz <strong>{phone}</strong> nömrəsindən ehtiyat hissələri kateqorisında <strong>{left_parts}</strong> elan yerləşdirə bilərsiniz.",
  "you_can_only_have_some_free_announcement_within_30_days": "Hörmətli İstifadəçi, Siz <strong>30</strong> gün ərzində Mashin.AL portalında minik, moto və ticari avtomobillər kateqoriyalarında <strong>3</strong> elan, ehtiyat hissələri kateqoriyasında isə <strong>6</strong> elan pulsuz yerləşdirə bilərsiniz.",
  ...
  "entrepreneurs_title": "<em>{count}</em> sahibkar artıq mashin.al-da öz biznesini uğurla inkişaf etdirir",
