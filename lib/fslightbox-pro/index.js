          ...
          !(function (e) {
              ...
              (function (e) {
                  var t,
                      ...
                      d = u(Q);
                  (s.addListeners =  () => {
                    if(event.props.types && ['custom','custom_interior'].includes(event.props.types[0])) {
                      if(event.stageIndexes.current !== 0) {
                        V()
      ...
      var Ke = Oe(
          {
              ...
              mounted: function () {
                if(C[this.fsLightboxIndex].props.types && ['custom','custom_interior'].includes(C[this.fsLightboxIndex].props.types[0])){
                  document.addEventListener("touchstart", () =>{

                    if(C[this.fsLightboxIndex].stageIndexes.current === 0 ) {
                      C[this.fsLightboxIndex].core.globalEventsController.removeListeners();
                    }else {
                      C[this.fsLightboxIndex].core.globalEventsController.removeListeners();
                      C[this.fsLightboxIndex].core.globalEventsController.addListeners();
                    }
                  }, { passive: !0 });
                }
