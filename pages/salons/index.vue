...
<!--                    <salon-filters-form :count="salonsFiltered.length"/>-->
                ...
                <div class="text-with-line" v-if="officialSalons.length">
                    <h2 class="title-with-line full-width d-flex align-items-center">
                        <span>{{ $t('official_salons') }}</span>
                        <span class="ml-auto salon-count">{{ officialSalons.length }} {{ $t('official_salons_2') }}</span>
                    </h2>
                </div>

                <div class="mb-lg-0 mb-n2 mt-2 mt-lg-3 row salon-card-list" v-if="officialSalons.length">
                    <div
