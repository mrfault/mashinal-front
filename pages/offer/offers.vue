          ...
          <div class="col col-md-4">
            <div class="offerUsers">
              ...
              <div class="user" v-for="userOffer in searchOffer" @click="getUserOfferDetail(userOffer.auto_salon_offer_id)">
                <div class="userImg" :style="'background-image: url('+(userOffer.auto_salon.logo ? userOffer.auto_salon.logo : '/images/offer/salon_no_logo.svg') +')'">
                </div>
                <div class="userName">
            ...
            <div class="offerDetail" v-if="offer">
              <div class="d-flex align-items-center user">
                ...
                <div class="actions" v-if="user_is_accepted">
                  ...
                  <span  @click="deleteUserAutoSalonOffer(userOffer.auto_salon_offer_id)"> <icon name="garbage"></icon></span>
                </div>
              </div>
...
export default {
  ...
  methods:{
    ...
    async changePage(param){
      await this.$store.dispatch('OffersAcceptedByAutoSalon',param)
    },
    submitMessage(){
