      ...
      <div class="container">
            ...
            <div class="row no-gutters scrolling-box">
               ...
               <div class="col-12 col-lg-6 col-xl-8">
                  <div class="login-image">
                     ...
                     <img
                        v-show="isDarkMode"
                        :src="`/login_image_${isMobileBreakpoint ? 'mobile_' : ''}${locale}_dark.svg`"
                        alt=""
                        style="width: 100%;"
                     />
                     <img
                        v-show="!isDarkMode"
                        :src="`/login_image_${isMobileBreakpoint ? 'mobile_' : ''}${locale}.svg`"
                        alt=""
                        style="width: 100%;"
                     />
                  </div>
         ...
         <div class="ma-login-tab" v-if="!isMobileBreakpoint">
            ...
            <div class="ma-login-tab--image" v-if="settingsV2?.media?.login_image">
               ...
               <img alt="login_img" :src="settingsV2.media?.login_image+'?width=644'">
            </div>
         </div>
