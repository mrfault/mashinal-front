<template>
   <div class="pages-policy pt-1 pt-lg-5">
      <div class="container">
         <breadcrumbs :crumbs="crumbs"/>

         <Cap>
            <template #left>
               <h3>Qaydalar və şərtlər</h3>
            </template>
         </Cap>
         ...
         <div class="pages-policy__content">
            ...
            >
               ...
               <div class="pages-policy__content-text">
                  ...
                  <p>Elanların yerləşdirilməsi, şəkillər, əlaqə vasitələri, elana düzəliş edilməsi, qara siyahı və texniki dəstək xidməti barədə qaydalar</p>
               </div>
            </nuxt-link>
         </div>
