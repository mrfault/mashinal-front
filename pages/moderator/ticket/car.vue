                  ...
                  >
                    ...
                    <p>{{ smsRadarData.vehBodyType }}</p>
                              ...
                              <div v-if="data.engines && form.generation_id" class="row">
                                 ...
                                 <div class="col-12 mb-1">
                                    <small v-if="single_announce.car_catalog.engine_id != form.engine"
                                           class="input_old_value">
                                       {{ $t('old_value_2') }}:
                                       {{ $t('engine_values')[single_announce.car_catalog.engine_id] }}
                                    </small>
                                 </div>
                                 <div class="col-12 col-lg-3 ">
                                    <form-select
                          ...
                          "
                              ...
                              <div v-if="data.gearings && form.engine" class="row">
                                 ...
                                 <div class="col-12 mb-1">
                                    <small v-if="single_announce.car_catalog.gearing_id !== form.gearing"
                                           class="input_old_value">
                                       {{ $t('old_value_2') }}:
                              ...
                              <div v-if="data.transmissions && data.transmissions.length && form.gearing" class="row">
                                 ...
                                 <div class="col-12 mb-1">
                                    <small v-if="single_announce.car_catalog.box_id !== form.transmission"
                                           class="input_old_value">
                                       {{ $t('old_value_2') }}: {{
                                          $t('box_values')[single_announce.car_catalog.box_id]
                                       }}
                                    </small>
                                 </div>
                                 <div class="col-12 col-lg-3 ">
                    ...
                    "
                              ...
                              <!--              modification-->
                              <div v-if="data.modifications && data.modifications.length && form.transmission"
                                   class="row">
                                 <div class="col-12">
                                    <title-with-line-and-reject-reason
      ...
      async getAnnounceData() {
         ...
         try {
            ...
            this.form = {
               ...
               seats_count: data.announce?.seats_count,
               youtube: {
