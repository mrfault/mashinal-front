...
export const MenusDataMixin = {
   ...
   computed: {
      ...
      searchMenus() {
         return [
            {id: 1, label: 'car', title: 'cars', api_key: "getBrands", route: '/cars', icon: '/icons/car3.svg'},
            {id: 4, label: 'moto', title: 'moto', api_key: "getMotoOptionsV2", route: '/moto', children: this.motoMenus, icon: '/icons/moto3.svg'},
            {id: 5, label: 'parts', title: 'parts', api_key: "getPartCategories", route: '/parts', children: this.partsMenus, icon: '/icons/partsV2.svg'},
            {id: 2, label: 'registration_marks', title: 'registration_marks', api_key: "fetchRegionNumbers", route: '/plates', icon: '/icons/registration_markV2.svg'},
            {id: 3, label: 'commercial', title: 'commercial', api_key: "getBrands", route: '/commercial', children: this.commercialMenus, icon: 'commercial-1'},
         ];
      },
