...
export const MenusDataMixin = {
   ...
   computed: {
      ...
      searchMenus() {
         return [
            {id: 1, label: 'car', title: 'cars', api_key: "getBrands", route: '/cars', icon: 'car-1'},
            {id: 4, label: 'moto', title: 'moto', api_key: "getMotoOptionsV2", route: '/moto', children: this.motoMenus, icon: 'moto-1'},
            {id: 5, label: 'parts', title: 'parts', api_key: "getPartCategories", route: '/parts', children: this.partsMenus, icon: 'parts'},
            {id: 2, label: 'registration_marks', title: 'registration_marks', api_key: "fetchRegionNumbers", route: '/plates', icon: '/icons/registration_marks.svg'},
