      ...
      return [
        {
          ...
          route: this.$localePath('/parts/' + this.$t('slug_parts')),
          icon: 'part-1',
          showOnMenu: true
        },{
          ...
          route: this.$localePath('/parts/' + this.$t('slug_tyres')),
          icon: 'part-2',
          showOnMenu: true
        },{
          title: 'tyres',
          ...
          route: this.$localePath('/parts/' + this.$t('slug_rims')),
          icon: null,
          showOnMenu: false
        },{
          ...
          route: this.$localePath('/parts/' + this.$t('slug_oil_and_auto_chemistry')),
          icon: 'part-3',
          showOnMenu: true
        },{
          title: 'batteries',
          ...
          route: this.$localePath('/parts/' + this.$t('slug_batteries')),
          icon: 'part-4',
          showOnMenu: true
        },{
          ...
          route: this.$localePath('/parts/' + this.$t('slug_auto_accessories')),
          icon: 'part-5',
          showOnMenu: true
        },{
          title: 'repair_tools',
          ...
          route: this.$localePath('/parts/' + this.$t('slug_repair_tools')),
          icon: 'part-6',
          showOnMenu: true
        },
      ]
